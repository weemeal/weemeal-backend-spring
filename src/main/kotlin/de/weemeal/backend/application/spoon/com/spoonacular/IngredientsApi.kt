...
class IngredientsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) :
    ...
    fun autocompleteIngredientSearch(
        ...
        metaInformation: kotlin.Boolean? = null,
        intolerances: kotlin.String? = null,
        language: LanguageAutocompleteIngredientSearch? = null
    ): kotlin.collections.Set<AutocompleteIngredientSearch200ResponseInner> {
        val localVarResponse = autocompleteIngredientSearchWithHttpInfo(
            query = query,
            number = number,
    ...
    fun autocompleteIngredientSearchWithHttpInfo(
        query: kotlin.String,
        number: kotlin.Int?,
        metaInformation: kotlin.Boolean?,
        intolerances: kotlin.String?,
        language: LanguageAutocompleteIngredientSearch?
    ): ApiResponse<kotlin.collections.Set<AutocompleteIngredientSearch200ResponseInner>?> {
        val localVariableConfig = autocompleteIngredientSearchRequestConfig(
            query = query,
            number = number,
            metaInformation = metaInformation,
            intolerances = intolerances,
     ...
     */
    fun autocompleteIngredientSearchRequestConfig(
        query: kotlin.String,
        number: kotlin.Int?,
        metaInformation: kotlin.Boolean?,
        intolerances: kotlin.String?,
    ...
    fun computeIngredientAmount(
        id: kotlin.Int,
        nutrient: kotlin.String,
        target: kotlin.Int,
        unit: kotlin.String? = null
    ): ComputeIngredientAmount200Response {
        val localVarResponse =
            computeIngredientAmountWithHttpInfo(id = id, nutrient = nutrient, target = target, unit = unit)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun computeIngredientAmountWithHttpInfo(
        id: kotlin.Int,
        nutrient: kotlin.String,
        target: kotlin.Int,
        unit: kotlin.String?
        ...
        val localVariableConfig =
            computeIngredientAmountRequestConfig(id = id, nutrient = nutrient, target = target, unit = unit)
     ...
     * @return RequestConfig
     */
    fun computeIngredientAmountRequestConfig(
        id: kotlin.Int,
        nutrient: kotlin.String,
        target: kotlin.Int,
        unit: kotlin.String?
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getIngredientInformationWithHttpInfo(
        id: kotlin.Int,
     ...
     * @return RequestConfig
     */
    fun getIngredientInformationRequestConfig(
        id: kotlin.Int,
        amount: java.math.BigDecimal?,
        unit: kotlin.String?
    ): RequestConfig<Unit> {
    ...
    fun ingredientSearch(
        query: kotlin.String,
        addChildren: kotlin.Boolean? = null,
        minProteinPercent: java.math.BigDecimal? = null,
        maxProteinPercent: java.math.BigDecimal? = null,
        minFatPercent: java.math.BigDecimal? = null,
        maxFatPercent: java.math.BigDecimal? = null,
        minCarbsPercent: java.math.BigDecimal? = null,
        maxCarbsPercent: java.math.BigDecimal? = null,
        metaInformation: kotlin.Boolean? = null,
        intolerances: kotlin.String? = null,
        ...
        number: kotlin.Int? = 10,
        language: LanguageIngredientSearch? = null
    ): IngredientSearch200Response {
        val localVarResponse = ingredientSearchWithHttpInfo(
            query = query,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun ingredientSearchWithHttpInfo(
        query: kotlin.String,
        addChildren: kotlin.Boolean?,
        minProteinPercent: java.math.BigDecimal?,
        maxProteinPercent: java.math.BigDecimal?,
        minFatPercent: java.math.BigDecimal?,
        maxFatPercent: java.math.BigDecimal?,
        minCarbsPercent: java.math.BigDecimal?,
        maxCarbsPercent: java.math.BigDecimal?,
        metaInformation: kotlin.Boolean?,
        intolerances: kotlin.String?,
        sort: kotlin.String?,
        ...
        offset: kotlin.Int?,
        number: kotlin.Int?,
        language: LanguageIngredientSearch?
    ): ApiResponse<IngredientSearch200Response?> {
        val localVariableConfig = ingredientSearchRequestConfig(
            query = query,
            addChildren = addChildren,
            minProteinPercent = minProteinPercent,
            maxProteinPercent = maxProteinPercent,
     ...
     * @return RequestConfig
     */
    fun ingredientSearchRequestConfig(
        query: kotlin.String,
        addChildren: kotlin.Boolean?,
        minProteinPercent: java.math.BigDecimal?,
        maxProteinPercent: java.math.BigDecimal?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun ingredientsByIDImageWithHttpInfo(
        id: kotlin.Int,
        measure: MeasureIngredientsByIDImage?
    ...
    fun mapIngredientsToGroceryProducts(mapIngredientsToGroceryProductsRequest: MapIngredientsToGroceryProductsRequest): kotlin.collections.Set<MapIngredientsToGroceryProducts200ResponseInner> {
        val localVarResponse =
            mapIngredientsToGroceryProductsWithHttpInfo(mapIngredientsToGroceryProductsRequest = mapIngredientsToGroceryProductsRequest)
    ...
    fun mapIngredientsToGroceryProductsWithHttpInfo(mapIngredientsToGroceryProductsRequest: MapIngredientsToGroceryProductsRequest): ApiResponse<kotlin.collections.Set<MapIngredientsToGroceryProducts200ResponseInner>?> {
        val localVariableConfig =
            mapIngredientsToGroceryProductsRequestConfig(mapIngredientsToGroceryProductsRequest = mapIngredientsToGroceryProductsRequest)
    ...
    fun visualizeIngredients(
        ...
        language: LanguageVisualizeIngredients? = null,
        measure: MeasureVisualizeIngredients? = null,
        view: ViewVisualizeIngredients? = null,
        defaultCss: kotlin.Boolean? = null,
        showBacklink: kotlin.Boolean? = null
    ): kotlin.String {
        val localVarResponse = visualizeIngredientsWithHttpInfo(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeIngredientsWithHttpInfo(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizeIngredients?,
        measure: MeasureVisualizeIngredients?,
        view: ViewVisualizeIngredients?,
        defaultCss: kotlin.Boolean?,
        showBacklink: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
        val localVariableConfig = visualizeIngredientsRequestConfig(
            ingredientList = ingredientList,
            servings = servings,
            language = language,
            measure = measure,
     ...
     * @return RequestConfig
     */
    fun visualizeIngredientsRequestConfig(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizeIngredients?,
        measure: MeasureVisualizeIngredients?,
