...
class RecipesApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) :
    ...
    ): kotlin.collections.Set<AutocompleteRecipeSearch200ResponseInner> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun autocompleteRecipeSearchWithHttpInfo(
        query: kotlin.String,
        number: kotlin.Int?
    ): ApiResponse<kotlin.collections.Set<AutocompleteRecipeSearch200ResponseInner>?> {
    ...
    fun classifyCuisine(
        ...
        language: LanguageClassifyCuisine? = null
    ): ClassifyCuisine200Response {
        val localVarResponse =
            classifyCuisineWithHttpInfo(title = title, ingredientList = ingredientList, language = language)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun classifyCuisineWithHttpInfo(
        title: kotlin.String,
        ingredientList: kotlin.String,
        language: LanguageClassifyCuisine?
    ): ApiResponse<ClassifyCuisine200Response?> {
        val localVariableConfig =
            classifyCuisineRequestConfig(title = title, ingredientList = ingredientList, language = language)
     ...
     * @return RequestConfig
     */
    fun classifyCuisineRequestConfig(
        title: kotlin.String,
        ingredientList: kotlin.String,
        language: LanguageClassifyCuisine?
    ...
    fun computeGlycemicLoad(
        computeGlycemicLoadRequest: ComputeGlycemicLoadRequest,
        language: LanguageComputeGlycemicLoad? = null
    ): ComputeGlycemicLoad200Response {
        val localVarResponse = computeGlycemicLoadWithHttpInfo(
            computeGlycemicLoadRequest = computeGlycemicLoadRequest,
            language = language
        )
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun computeGlycemicLoadWithHttpInfo(
        computeGlycemicLoadRequest: ComputeGlycemicLoadRequest,
        language: LanguageComputeGlycemicLoad?
    ): ApiResponse<ComputeGlycemicLoad200Response?> {
        val localVariableConfig = computeGlycemicLoadRequestConfig(
            computeGlycemicLoadRequest = computeGlycemicLoadRequest,
            language = language
        )
     ...
     * @return RequestConfig
     */
    fun computeGlycemicLoadRequestConfig(
        computeGlycemicLoadRequest: ComputeGlycemicLoadRequest,
        language: LanguageComputeGlycemicLoad?
    ): RequestConfig<ComputeGlycemicLoadRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun convertAmountsWithHttpInfo(
        ingredientName: kotlin.String,
        sourceAmount: java.math.BigDecimal,
        sourceUnit: kotlin.String,
        targetUnit: kotlin.String
    ): ApiResponse<ConvertAmounts200Response?> {
        val localVariableConfig = convertAmountsRequestConfig(
            ingredientName = ingredientName,
            sourceAmount = sourceAmount,
            sourceUnit = sourceUnit,
            targetUnit = targetUnit
     ...
     * @return RequestConfig
     */
    fun convertAmountsRequestConfig(
        ingredientName: kotlin.String,
        sourceAmount: java.math.BigDecimal,
        sourceUnit: kotlin.String,
        targetUnit: kotlin.String
    ...
    enum class MaskCreateRecipeCard(val value: kotlin.String) {
        @Json(name = "ellipseMask")
        ellipseMask("ellipseMask"),
        @Json(name = "diamondMask")
    ...
    enum class BackgroundImageCreateRecipeCard(val value: kotlin.String) {
        @Json(name = "none")
        none("none"),
        @Json(name = "background1")
        background1("background1"),
        @Json(name = "background2")
    ...
    fun createRecipeCard(
        title: kotlin.String,
        ingredients: kotlin.String,
        instructions: kotlin.String,
        readyInMinutes: java.math.BigDecimal,
        servings: java.math.BigDecimal,
        mask: MaskCreateRecipeCard,
        backgroundImage: BackgroundImageCreateRecipeCard,
        image: java.io.File? = null,
        imageUrl: kotlin.String? = null,
        author: kotlin.String? = null,
        backgroundColor: kotlin.String? = null,
        fontColor: kotlin.String? = null,
        source: kotlin.String? = null
    ...
    fun createRecipeCardWithHttpInfo(
        ...
        val localVariableConfig = createRecipeCardRequestConfig(
            title = title,
            ingredients = ingredients,
            instructions = instructions,
            readyInMinutes = readyInMinutes,
    ...
    fun extractRecipeFromWebsite(
        url: kotlin.String,
        forceExtraction: kotlin.Boolean? = null,
        analyze: kotlin.Boolean? = null,
        includeNutrition: kotlin.Boolean? = false,
        includeTaste: kotlin.Boolean? = false
    ): RecipeInformation {
        val localVarResponse = extractRecipeFromWebsiteWithHttpInfo(
            url = url,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun extractRecipeFromWebsiteWithHttpInfo(
        url: kotlin.String,
        forceExtraction: kotlin.Boolean?,
        analyze: kotlin.Boolean?,
        includeNutrition: kotlin.Boolean?,
        includeTaste: kotlin.Boolean?
    ): ApiResponse<RecipeInformation?> {
        val localVariableConfig = extractRecipeFromWebsiteRequestConfig(
            url = url,
            forceExtraction = forceExtraction,
            analyze = analyze,
            includeNutrition = includeNutrition,
     ...
     * @return RequestConfig
     */
    fun extractRecipeFromWebsiteRequestConfig(
        url: kotlin.String,
        forceExtraction: kotlin.Boolean?,
        analyze: kotlin.Boolean?,
        includeNutrition: kotlin.Boolean?,
    ...
    fun getAnalyzedRecipeInstructions(
        id: kotlin.Int,
        stepBreakdown: kotlin.Boolean? = null
    ): kotlin.collections.List<GetAnalyzedRecipeInstructions200ResponseInner> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAnalyzedRecipeInstructionsWithHttpInfo(
        id: kotlin.Int,
        stepBreakdown: kotlin.Boolean?
    ): ApiResponse<kotlin.collections.List<GetAnalyzedRecipeInstructions200ResponseInner>?> {
     ...
     * @return RequestConfig
     */
    fun getAnalyzedRecipeInstructionsRequestConfig(
        id: kotlin.Int,
        stepBreakdown: kotlin.Boolean?
    ): RequestConfig<Unit> {
        val localVariableBody = null
    ...
    fun getRandomRecipes(
        includeNutrition: kotlin.Boolean? = false,
        includeTags: kotlin.String? = null,
        excludeTags: kotlin.String? = null,
        number: kotlin.Int? = 10
    ): GetRandomRecipes200Response {
        val localVarResponse = getRandomRecipesWithHttpInfo(
            includeNutrition = includeNutrition,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRandomRecipesWithHttpInfo(
        includeNutrition: kotlin.Boolean?,
        includeTags: kotlin.String?,
        excludeTags: kotlin.String?,
        number: kotlin.Int?
    ): ApiResponse<GetRandomRecipes200Response?> {
        val localVariableConfig = getRandomRecipesRequestConfig(
            includeNutrition = includeNutrition,
            includeTags = includeTags,
            excludeTags = excludeTags,
            number = number
     ...
     * @return RequestConfig
     */
    fun getRandomRecipesRequestConfig(
        includeNutrition: kotlin.Boolean?,
        includeTags: kotlin.String?,
        excludeTags: kotlin.String?,
        number: kotlin.Int?
    ...
    fun getRecipeInformation(
        id: kotlin.Int,
        includeNutrition: kotlin.Boolean? = false,
        addWinePairing: kotlin.Boolean? = null,
        addTasteData: kotlin.Boolean? = null
    ): RecipeInformation {
        val localVarResponse = getRecipeInformationWithHttpInfo(
            id = id,
            includeNutrition = includeNutrition,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRecipeInformationWithHttpInfo(
        id: kotlin.Int,
        includeNutrition: kotlin.Boolean?,
        addWinePairing: kotlin.Boolean?,
        addTasteData: kotlin.Boolean?
    ): ApiResponse<RecipeInformation?> {
        val localVariableConfig = getRecipeInformationRequestConfig(
            id = id,
            includeNutrition = includeNutrition,
            addWinePairing = addWinePairing,
            addTasteData = addTasteData
     ...
     * @return RequestConfig
     */
    fun getRecipeInformationRequestConfig(
        id: kotlin.Int,
        includeNutrition: kotlin.Boolean?,
        addWinePairing: kotlin.Boolean?,
        addTasteData: kotlin.Boolean?
    ...
    fun getRecipeInformationBulk(
        ids: kotlin.String,
        includeNutrition: kotlin.Boolean? = false
    ): kotlin.collections.Set<RecipeInformation> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRecipeInformationBulkWithHttpInfo(
        ids: kotlin.String,
        includeNutrition: kotlin.Boolean?
    ): ApiResponse<kotlin.collections.Set<RecipeInformation>?> {
     ...
     * @return RequestConfig
     */
    fun getRecipeInformationBulkRequestConfig(
        ids: kotlin.String,
        includeNutrition: kotlin.Boolean?
    ): RequestConfig<Unit> {
        val localVariableBody = null
    ...
    fun getRecipePriceBreakdownByIDRequestConfig(id: kotlin.Int): RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/recipes/{id}/priceBreakdownWidget.json".replace(
                "{" + "id" + "}",
    ...
    fun getSimilarRecipes(
        id: kotlin.Int,
        number: kotlin.Int? = 10
    ): kotlin.collections.Set<GetSimilarRecipes200ResponseInner> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getSimilarRecipesWithHttpInfo(
        id: kotlin.Int,
        number: kotlin.Int?
    ): ApiResponse<kotlin.collections.Set<GetSimilarRecipes200ResponseInner>?> {
    ...
    fun parseIngredients(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageParseIngredients? = null,
        includeNutrition: kotlin.Boolean? = null
    ): kotlin.collections.Set<IngredientInformation> {
        val localVarResponse = parseIngredientsWithHttpInfo(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun parseIngredientsWithHttpInfo(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageParseIngredients?,
        includeNutrition: kotlin.Boolean?
    ): ApiResponse<kotlin.collections.Set<IngredientInformation>?> {
        val localVariableConfig = parseIngredientsRequestConfig(
            ingredientList = ingredientList,
            servings = servings,
            language = language,
            includeNutrition = includeNutrition
     ...
     * @return RequestConfig
     */
    fun parseIngredientsRequestConfig(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageParseIngredients?,
        includeNutrition: kotlin.Boolean?
    ...
    fun priceBreakdownByIDImageRequestConfig(id: kotlin.Int): RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/recipes/{id}/priceBreakdownWidget.png".replace(
                "{" + "id" + "}",
                encodeURIComponent(id.toString())
            ),
            query = localVariableQuery,
     ...
     * @return RequestConfig
     */
    fun recipeNutritionLabelImageRequestConfig(
        id: kotlin.Int,
        showOptionalNutrients: kotlin.Boolean?,
        showZeroValues: kotlin.Boolean?,
        showIngredients: kotlin.Boolean?
    ...
    fun recipeNutritionLabelWidget(
        id: kotlin.Int,
        ...
        val localVarResponse = recipeNutritionLabelWidgetWithHttpInfo(
            id = id,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun recipeNutritionLabelWidgetWithHttpInfo(
        id: kotlin.Int,
        ...
        val localVariableConfig = recipeNutritionLabelWidgetRequestConfig(
            id = id,
            defaultCss = defaultCss,
            showOptionalNutrients = showOptionalNutrients,
            showZeroValues = showZeroValues,
     ...
     * @return RequestConfig
     */
    fun recipeNutritionLabelWidgetRequestConfig(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?,
        showOptionalNutrients: kotlin.Boolean?,
        showZeroValues: kotlin.Boolean?,
    ...
    fun recipeTasteByIDImage(
        id: kotlin.Int,
        normalize: kotlin.Boolean? = null,
        rgb: kotlin.String? = null
    ): java.io.File {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun recipeTasteByIDImageWithHttpInfo(
        id: kotlin.Int,
        normalize: kotlin.Boolean?,
        rgb: kotlin.String?
    ): ApiResponse<java.io.File?> {
     ...
     * @return RequestConfig
     */
    fun recipeTasteByIDImageRequestConfig(
        id: kotlin.Int,
        normalize: kotlin.Boolean?,
        rgb: kotlin.String?
    ): RequestConfig<Unit> {
    ...
    fun searchRecipes(
        ...
        excludeCuisine: kotlin.String? = null,
        diet: kotlin.String? = null,
        intolerances: kotlin.String? = null,
        equipment: kotlin.String? = null,
        includeIngredients: kotlin.String? = null,
        excludeIngredients: kotlin.String? = null,
        type: kotlin.String? = null,
        instructionsRequired: kotlin.Boolean? = null,
        fillIngredients: kotlin.Boolean? = null,
        addRecipeInformation: kotlin.Boolean? = null,
        addRecipeNutrition: kotlin.Boolean? = null,
        author: kotlin.String? = null,
        tags: kotlin.String? = null,
        recipeBoxId: kotlin.Int? = null,
        titleMatch: kotlin.String? = null,
        maxReadyTime: java.math.BigDecimal? = null,
        minServings: java.math.BigDecimal? = null,
        maxServings: java.math.BigDecimal? = null,
        ignorePantry: kotlin.Boolean? = false,
        sort: kotlin.String? = null,
        sortDirection: kotlin.String? = null,
        ...
        minAlcohol: java.math.BigDecimal? = null,
        maxAlcohol: java.math.BigDecimal? = null,
        minCaffeine: java.math.BigDecimal? = null,
        maxCaffeine: java.math.BigDecimal? = null,
        minCopper: java.math.BigDecimal? = null,
        maxCopper: java.math.BigDecimal? = null,
        minCalcium: java.math.BigDecimal? = null,
        maxCalcium: java.math.BigDecimal? = null,
        minCholine: java.math.BigDecimal? = null,
        maxCholine: java.math.BigDecimal? = null,
        minCholesterol: java.math.BigDecimal? = null,
        maxCholesterol: java.math.BigDecimal? = null,
        minFluoride: java.math.BigDecimal? = null,
        maxFluoride: java.math.BigDecimal? = null,
        minSaturatedFat: java.math.BigDecimal? = null,
        maxSaturatedFat: java.math.BigDecimal? = null,
        minVitaminA: java.math.BigDecimal? = null,
        maxVitaminA: java.math.BigDecimal? = null,
        minVitaminC: java.math.BigDecimal? = null,
        maxVitaminC: java.math.BigDecimal? = null,
        minVitaminD: java.math.BigDecimal? = null,
        maxVitaminD: java.math.BigDecimal? = null,
        minVitaminE: java.math.BigDecimal? = null,
        maxVitaminE: java.math.BigDecimal? = null,
        minVitaminK: java.math.BigDecimal? = null,
        maxVitaminK: java.math.BigDecimal? = null,
        minVitaminB1: java.math.BigDecimal? = null,
        maxVitaminB1: java.math.BigDecimal? = null,
        minVitaminB2: java.math.BigDecimal? = null,
        maxVitaminB2: java.math.BigDecimal? = null,
        minVitaminB5: java.math.BigDecimal? = null,
        maxVitaminB5: java.math.BigDecimal? = null,
        minVitaminB3: java.math.BigDecimal? = null,
        maxVitaminB3: java.math.BigDecimal? = null,
        minVitaminB6: java.math.BigDecimal? = null,
        maxVitaminB6: java.math.BigDecimal? = null,
        minVitaminB12: java.math.BigDecimal? = null,
        maxVitaminB12: java.math.BigDecimal? = null,
        minFiber: java.math.BigDecimal? = null,
        maxFiber: java.math.BigDecimal? = null,
        minFolate: java.math.BigDecimal? = null,
        maxFolate: java.math.BigDecimal? = null,
        minFolicAcid: java.math.BigDecimal? = null,
        maxFolicAcid: java.math.BigDecimal? = null,
        minIodine: java.math.BigDecimal? = null,
        maxIodine: java.math.BigDecimal? = null,
        minIron: java.math.BigDecimal? = null,
        maxIron: java.math.BigDecimal? = null,
        minMagnesium: java.math.BigDecimal? = null,
        maxMagnesium: java.math.BigDecimal? = null,
        minManganese: java.math.BigDecimal? = null,
        maxManganese: java.math.BigDecimal? = null,
        minPhosphorus: java.math.BigDecimal? = null,
        maxPhosphorus: java.math.BigDecimal? = null,
        minPotassium: java.math.BigDecimal? = null,
        maxPotassium: java.math.BigDecimal? = null,
        minSelenium: java.math.BigDecimal? = null,
        maxSelenium: java.math.BigDecimal? = null,
        minSodium: java.math.BigDecimal? = null,
        maxSodium: java.math.BigDecimal? = null,
        minSugar: java.math.BigDecimal? = null,
        maxSugar: java.math.BigDecimal? = null,
        minZinc: java.math.BigDecimal? = null,
        maxZinc: java.math.BigDecimal? = null,
        offset: kotlin.Int? = null,
        number: kotlin.Int? = 10
    ): SearchRecipes200Response {
        val localVarResponse = searchRecipesWithHttpInfo(
            query = query,
            cuisine = cuisine,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun searchRecipesWithHttpInfo(
        query: kotlin.String,
        cuisine: kotlin.String?,
        excludeCuisine: kotlin.String?,
        diet: kotlin.String?,
        intolerances: kotlin.String?,
        equipment: kotlin.String?,
        includeIngredients: kotlin.String?,
        excludeIngredients: kotlin.String?,
        type: kotlin.String?,
        instructionsRequired: kotlin.Boolean?,
        fillIngredients: kotlin.Boolean?,
        addRecipeInformation: kotlin.Boolean?,
        addRecipeNutrition: kotlin.Boolean?,
        author: kotlin.String?,
        tags: kotlin.String?,
        recipeBoxId: kotlin.Int?,
        titleMatch: kotlin.String?,
        maxReadyTime: java.math.BigDecimal?,
        minServings: java.math.BigDecimal?,
        maxServings: java.math.BigDecimal?,
        ignorePantry: kotlin.Boolean?,
        sort: kotlin.String?,
        sortDirection: kotlin.String?,
        ...
        minAlcohol: java.math.BigDecimal?,
        maxAlcohol: java.math.BigDecimal?,
        minCaffeine: java.math.BigDecimal?,
        maxCaffeine: java.math.BigDecimal?,
        minCopper: java.math.BigDecimal?,
        maxCopper: java.math.BigDecimal?,
        minCalcium: java.math.BigDecimal?,
        maxCalcium: java.math.BigDecimal?,
        minCholine: java.math.BigDecimal?,
        maxCholine: java.math.BigDecimal?,
        minCholesterol: java.math.BigDecimal?,
        maxCholesterol: java.math.BigDecimal?,
        minFluoride: java.math.BigDecimal?,
        maxFluoride: java.math.BigDecimal?,
        minSaturatedFat: java.math.BigDecimal?,
        maxSaturatedFat: java.math.BigDecimal?,
        minVitaminA: java.math.BigDecimal?,
        maxVitaminA: java.math.BigDecimal?,
        minVitaminC: java.math.BigDecimal?,
        maxVitaminC: java.math.BigDecimal?,
        minVitaminD: java.math.BigDecimal?,
        maxVitaminD: java.math.BigDecimal?,
        minVitaminE: java.math.BigDecimal?,
        maxVitaminE: java.math.BigDecimal?,
        minVitaminK: java.math.BigDecimal?,
        maxVitaminK: java.math.BigDecimal?,
        minVitaminB1: java.math.BigDecimal?,
        maxVitaminB1: java.math.BigDecimal?,
        minVitaminB2: java.math.BigDecimal?,
        maxVitaminB2: java.math.BigDecimal?,
        minVitaminB5: java.math.BigDecimal?,
        maxVitaminB5: java.math.BigDecimal?,
        minVitaminB3: java.math.BigDecimal?,
        maxVitaminB3: java.math.BigDecimal?,
        minVitaminB6: java.math.BigDecimal?,
        maxVitaminB6: java.math.BigDecimal?,
        minVitaminB12: java.math.BigDecimal?,
        maxVitaminB12: java.math.BigDecimal?,
        minFiber: java.math.BigDecimal?,
        maxFiber: java.math.BigDecimal?,
        minFolate: java.math.BigDecimal?,
        maxFolate: java.math.BigDecimal?,
        minFolicAcid: java.math.BigDecimal?,
        maxFolicAcid: java.math.BigDecimal?,
        minIodine: java.math.BigDecimal?,
        maxIodine: java.math.BigDecimal?,
        minIron: java.math.BigDecimal?,
        maxIron: java.math.BigDecimal?,
        minMagnesium: java.math.BigDecimal?,
        maxMagnesium: java.math.BigDecimal?,
        minManganese: java.math.BigDecimal?,
        maxManganese: java.math.BigDecimal?,
        minPhosphorus: java.math.BigDecimal?,
        maxPhosphorus: java.math.BigDecimal?,
        minPotassium: java.math.BigDecimal?,
        maxPotassium: java.math.BigDecimal?,
        minSelenium: java.math.BigDecimal?,
        maxSelenium: java.math.BigDecimal?,
        minSodium: java.math.BigDecimal?,
        maxSodium: java.math.BigDecimal?,
        minSugar: java.math.BigDecimal?,
        maxSugar: java.math.BigDecimal?,
        minZinc: java.math.BigDecimal?,
        maxZinc: java.math.BigDecimal?,
        offset: kotlin.Int?,
        number: kotlin.Int?
     ...
     * @return RequestConfig
     */
    fun searchRecipesRequestConfig(
        query: kotlin.String,
        cuisine: kotlin.String?,
        excludeCuisine: kotlin.String?,
        diet: kotlin.String?,
    ...
    fun searchRecipesByIngredients(
        ingredients: kotlin.String,
        number: kotlin.Int? = 10,
        ranking: kotlin.Int? = null,
        ignorePantry: kotlin.Boolean? = false
    ): kotlin.collections.Set<SearchRecipesByIngredients200ResponseInner> {
        val localVarResponse = searchRecipesByIngredientsWithHttpInfo(
            ingredients = ingredients,
            number = number,
            ranking = ranking,
            ignorePantry = ignorePantry
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun searchRecipesByIngredientsWithHttpInfo(
        ingredients: kotlin.String,
        number: kotlin.Int?,
        ranking: kotlin.Int?,
        ignorePantry: kotlin.Boolean?
    ): ApiResponse<kotlin.collections.Set<SearchRecipesByIngredients200ResponseInner>?> {
        val localVariableConfig = searchRecipesByIngredientsRequestConfig(
            ingredients = ingredients,
            number = number,
            ranking = ranking,
            ignorePantry = ignorePantry
     ...
     * @return RequestConfig
     */
    fun searchRecipesByIngredientsRequestConfig(
        ingredients: kotlin.String,
        number: kotlin.Int?,
        ranking: kotlin.Int?,
        ignorePantry: kotlin.Boolean?
    ...
    fun searchRecipesByNutrients(
        ...
        offset: kotlin.Int? = null,
        number: kotlin.Int? = 10,
        random: kotlin.Boolean? = null
    ): kotlin.collections.Set<SearchRecipesByNutrients200ResponseInner> {
    ...
    fun searchRecipesByNutrientsWithHttpInfo(
        ...
        offset: kotlin.Int?,
        number: kotlin.Int?,
        random: kotlin.Boolean?
    ): ApiResponse<kotlin.collections.Set<SearchRecipesByNutrients200ResponseInner>?> {
        val localVariableConfig = searchRecipesByNutrientsRequestConfig(
            minCarbs = minCarbs,
            maxCarbs = maxCarbs,
            minProtein = minProtein,
            maxProtein = maxProtein,
     ...
     * @return RequestConfig
     */
    fun searchRecipesByNutrientsRequestConfig(
        minCarbs: java.math.BigDecimal?,
        maxCarbs: java.math.BigDecimal?,
        minProtein: java.math.BigDecimal?,
        maxProtein: java.math.BigDecimal?,
    ...
    fun visualizeEquipment(
        instructions: kotlin.String,
        view: ViewVisualizeEquipment? = null,
        defaultCss: kotlin.Boolean? = null,
        showBacklink: kotlin.Boolean? = null
    ): kotlin.String {
        val localVarResponse = visualizeEquipmentWithHttpInfo(
            instructions = instructions,
            view = view,
            defaultCss = defaultCss,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeEquipmentWithHttpInfo(
        instructions: kotlin.String,
        view: ViewVisualizeEquipment?,
        defaultCss: kotlin.Boolean?,
        showBacklink: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
        val localVariableConfig = visualizeEquipmentRequestConfig(
            instructions = instructions,
            view = view,
            defaultCss = defaultCss,
            showBacklink = showBacklink
     ...
     * @return RequestConfig
     */
    fun visualizeEquipmentRequestConfig(
        instructions: kotlin.String,
        view: ViewVisualizeEquipment?,
        defaultCss: kotlin.Boolean?,
        showBacklink: kotlin.Boolean?
    ...
    fun visualizePriceBreakdown(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizePriceBreakdown? = null,
        mode: java.math.BigDecimal? = null,
        defaultCss: kotlin.Boolean? = null,
        showBacklink: kotlin.Boolean? = null
    ): kotlin.String {
        val localVarResponse = visualizePriceBreakdownWithHttpInfo(
            ingredientList = ingredientList,
            servings = servings,
            language = language,
            mode = mode,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizePriceBreakdownWithHttpInfo(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizePriceBreakdown?,
        mode: java.math.BigDecimal?,
        defaultCss: kotlin.Boolean?,
        showBacklink: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
        val localVariableConfig = visualizePriceBreakdownRequestConfig(
            ingredientList = ingredientList,
            servings = servings,
            language = language,
            mode = mode,
     ...
     * @return RequestConfig
     */
    fun visualizePriceBreakdownRequestConfig(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizePriceBreakdown?,
        mode: java.math.BigDecimal?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeRecipeEquipmentByIDWithHttpInfo(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
    ...
    fun visualizeRecipeIngredientsByID(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean? = true,
        measure: MeasureVisualizeRecipeIngredientsByID? = null
    ): kotlin.String {
        val localVarResponse =
            visualizeRecipeIngredientsByIDWithHttpInfo(id = id, defaultCss = defaultCss, measure = measure)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeRecipeIngredientsByIDWithHttpInfo(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?,
        measure: MeasureVisualizeRecipeIngredientsByID?
    ): ApiResponse<kotlin.String?> {
        val localVariableConfig =
            visualizeRecipeIngredientsByIDRequestConfig(id = id, defaultCss = defaultCss, measure = measure)
     ...
     * @return RequestConfig
     */
    fun visualizeRecipeIngredientsByIDRequestConfig(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?,
        measure: MeasureVisualizeRecipeIngredientsByID?
    ): RequestConfig<Unit> {
    ...
    fun visualizeRecipeNutrition(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizeRecipeNutrition? = null,
        defaultCss: kotlin.Boolean? = null,
        showBacklink: kotlin.Boolean? = null
    ): kotlin.String {
        val localVarResponse = visualizeRecipeNutritionWithHttpInfo(
            ingredientList = ingredientList,
            servings = servings,
            language = language,
            defaultCss = defaultCss,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeRecipeNutritionWithHttpInfo(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizeRecipeNutrition?,
        defaultCss: kotlin.Boolean?,
        showBacklink: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
        val localVariableConfig = visualizeRecipeNutritionRequestConfig(
            ingredientList = ingredientList,
            servings = servings,
            language = language,
            defaultCss = defaultCss,
     ...
     * @return RequestConfig
     */
    fun visualizeRecipeNutritionRequestConfig(
        ingredientList: kotlin.String,
        servings: java.math.BigDecimal,
        language: LanguageVisualizeRecipeNutrition?,
        defaultCss: kotlin.Boolean?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeRecipeNutritionByIDWithHttpInfo(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeRecipePriceBreakdownByIDWithHttpInfo(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
     ...
     * @return RequestConfig
     */
    fun visualizeRecipePriceBreakdownByIDRequestConfig(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?
    ): RequestConfig<Unit> {
        val localVariableBody = null
    ...
    fun visualizeRecipeTaste(
        ingredientList: kotlin.String,
        language: LanguageVisualizeRecipeTaste? = null,
        normalize: kotlin.Boolean? = null,
        rgb: kotlin.String? = null
    ): kotlin.String {
        val localVarResponse = visualizeRecipeTasteWithHttpInfo(
            ingredientList = ingredientList,
            language = language,
            normalize = normalize,
            rgb = rgb
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeRecipeTasteWithHttpInfo(
        ingredientList: kotlin.String,
        language: LanguageVisualizeRecipeTaste?,
        normalize: kotlin.Boolean?,
        rgb: kotlin.String?
    ): ApiResponse<kotlin.String?> {
        val localVariableConfig = visualizeRecipeTasteRequestConfig(
            ingredientList = ingredientList,
            language = language,
            normalize = normalize,
            rgb = rgb
     ...
     * @return RequestConfig
     */
    fun visualizeRecipeTasteRequestConfig(
        ingredientList: kotlin.String,
        language: LanguageVisualizeRecipeTaste?,
        normalize: kotlin.Boolean?,
        rgb: kotlin.String?
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeRecipeTasteByIDWithHttpInfo(
        id: kotlin.Int,
        normalize: kotlin.Boolean?,
        rgb: kotlin.String?
    ): ApiResponse<kotlin.String?> {
     ...
     * @return RequestConfig
     */
    fun visualizeRecipeTasteByIDRequestConfig(
        id: kotlin.Int,
        normalize: kotlin.Boolean?,
        rgb: kotlin.String?
    ): RequestConfig<Unit> {
