...
class ProductsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) :
    ...
    fun autocompleteProductSearchWithHttpInfo(
        query: kotlin.String,
        number: kotlin.Int?
    ...
    fun classifyGroceryProduct(
        ...
        locale: LocaleClassifyGroceryProduct? = null
    ): ClassifyGroceryProduct200Response {
        val localVarResponse = classifyGroceryProductWithHttpInfo(
            classifyGroceryProductRequest = classifyGroceryProductRequest,
            locale = locale
        )
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun classifyGroceryProductWithHttpInfo(
        classifyGroceryProductRequest: ClassifyGroceryProductRequest,
        locale: LocaleClassifyGroceryProduct?
    ): ApiResponse<ClassifyGroceryProduct200Response?> {
        val localVariableConfig = classifyGroceryProductRequestConfig(
            classifyGroceryProductRequest = classifyGroceryProductRequest,
            locale = locale
        )
     ...
     * @return RequestConfig
     */
    fun classifyGroceryProductRequestConfig(
        classifyGroceryProductRequest: ClassifyGroceryProductRequest,
        locale: LocaleClassifyGroceryProduct?
    ): RequestConfig<ClassifyGroceryProductRequest> {
    ...
    fun classifyGroceryProductBulk(
        classifyGroceryProductBulkRequestInner: kotlin.collections.Set<ClassifyGroceryProductBulkRequestInner>,
        locale: kotlin.String? = null
    ): kotlin.collections.Set<ClassifyGroceryProductBulk200ResponseInner> {
        val localVarResponse = classifyGroceryProductBulkWithHttpInfo(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun classifyGroceryProductBulkWithHttpInfo(
        classifyGroceryProductBulkRequestInner: kotlin.collections.Set<ClassifyGroceryProductBulkRequestInner>,
        locale: kotlin.String?
    ): ApiResponse<kotlin.collections.Set<ClassifyGroceryProductBulk200ResponseInner>?> {
        val localVariableConfig = classifyGroceryProductBulkRequestConfig(
            classifyGroceryProductBulkRequestInner = classifyGroceryProductBulkRequestInner,
            locale = locale
        )
     ...
     * @return RequestConfig
     */
    fun classifyGroceryProductBulkRequestConfig(
        classifyGroceryProductBulkRequestInner: kotlin.collections.Set<ClassifyGroceryProductBulkRequestInner>,
        locale: kotlin.String?
    ): RequestConfig<kotlin.collections.Set<ClassifyGroceryProductBulkRequestInner>> {
    ...
    fun productNutritionByIDImageRequestConfig(id: kotlin.Int): RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/food/products/{id}/nutritionWidget.png".replace(
                "{" + "id" + "}",
     ...
     * @return RequestConfig
     */
    fun productNutritionLabelImageRequestConfig(
        id: kotlin.Int,
        showOptionalNutrients: kotlin.Boolean?,
        showZeroValues: kotlin.Boolean?,
        showIngredients: kotlin.Boolean?
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/food/products/{id}/nutritionLabel.png".replace(
                "{" + "id" + "}",
                encodeURIComponent(id.toString())
            ),
            query = localVariableQuery,
    ...
    fun productNutritionLabelWidget(
        id: kotlin.Int,
        ...
        val localVarResponse = productNutritionLabelWidgetWithHttpInfo(
            id = id,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun productNutritionLabelWidgetWithHttpInfo(
        id: kotlin.Int,
        ...
        val localVariableConfig = productNutritionLabelWidgetRequestConfig(
            id = id,
            defaultCss = defaultCss,
            showOptionalNutrients = showOptionalNutrients,
            showZeroValues = showZeroValues,
     ...
     * @return RequestConfig
     */
    fun productNutritionLabelWidgetRequestConfig(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?,
        showOptionalNutrients: kotlin.Boolean?,
        showZeroValues: kotlin.Boolean?,
    ...
    fun searchGroceryProducts(
        ...
        addProductInformation: kotlin.Boolean? = null,
        offset: kotlin.Int? = null,
        number: kotlin.Int? = 10
    ): SearchGroceryProducts200Response {
        val localVarResponse = searchGroceryProductsWithHttpInfo(
            query = query,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun searchGroceryProductsWithHttpInfo(
        query: kotlin.String,
        ...
        addProductInformation: kotlin.Boolean?,
        offset: kotlin.Int?,
        number: kotlin.Int?
    ): ApiResponse<SearchGroceryProducts200Response?> {
        val localVariableConfig = searchGroceryProductsRequestConfig(
            query = query,
            minCalories = minCalories,
            maxCalories = maxCalories,
            minCarbs = minCarbs,
     ...
     * @return RequestConfig
     */
    fun searchGroceryProductsRequestConfig(
        query: kotlin.String,
        minCalories: java.math.BigDecimal?,
        maxCalories: java.math.BigDecimal?,
        minCarbs: java.math.BigDecimal?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun visualizeProductNutritionByIDWithHttpInfo(
        id: kotlin.Int,
        defaultCss: kotlin.Boolean?
    ): ApiResponse<kotlin.String?> {
